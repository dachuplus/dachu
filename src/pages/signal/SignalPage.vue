  ...
  <div class="page-signal">
    ...
    <div v-if="activeTab === 'industry'">
      <div class="card">
        ...
        <p class="data-source">数据来源：大厨先生</p>
      </div>
    </div>
    ...
    <div v-if="activeTab === 'jqr'">
      ...
      <p class="data-source">数据来源：大厨先生（沪深300日线 / 全市场市盈率 / 新发基金），自建复合算法，仅供参考研究，不构成投资建议。</p>
...
const MACRO_SIGNAL_HELP = [
  ...
  '数据来源：大厨先生（沪深300 / 中证500 / 中证1000 的 PE 与历史分位、中国10Y国债收益率、Shibor、CPI、黄金价格、PMI 等公开宏观与市场数据）。',
