...
const routes = [
  ...
  },
  {
    ...
    meta: {
      tab: 'tools',
      title: '选品',
      description: '靠谱指数工具：靠谱基金指数评分、投顾产品精选、智能组合与数据中心的入口。',
  ...
  },
  {
    ...
    meta: {
      ...
      feature: 'fund-rank',
      title: '选品',
      description: '靠谱指数工具：覆盖全市场近2万只公募基金，按收益率、最大回撤、夏普比率综合排名，支持分类、份额、ETF/LOF 等多维筛选。',
      keywords: '靠谱指数工具,基金评分,基金排名,基金筛选,基金靠谱指数'
    }
  },
  {
    path: '/portfolio',
