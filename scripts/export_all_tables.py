...
def export_to_excel(table_name, rows, output_path):
    ...
    # 标题
    ws_meta.cell(row=row_idx, column=1, value='ALLFUND 数据说明').font = header_font
    ...
    row_idx += 1
    disclaimer = (
        '本数据由 ALLFUND 通过公开数据接口自动采集和计算，仅供参考，不构成任何投资建议。'
