#!/usr/bin/env python3
"""应用「我的内容」(articles) 模块 Schema 到 Supabase。

用法:
  SUPABASE_PAT=<pat> python3 scripts/create_articles_tables.py
...
SQL_FILE = os.path.join(os.path.dirname(__file__), "..", "supabase-articles-schema.sql")
...
def main():
    ...
    if resp.status_code >= 400:
        sys.exit(1)
    print("[OK] articles schema applied")
